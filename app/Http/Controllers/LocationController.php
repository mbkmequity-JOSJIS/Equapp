...
class LocationController extends Controller
{
    ...
    public function __construct(FirebaseService $firebase)
    {
        ...
        $aquaviskaData = $this->firebase->getDataAquaviska();

        $aquaviskaData = is_array($aquaviskaData) ? $aquaviskaData : (array) $aquaviskaData;
        // dd($aquaviskaData['Area-1']['latest'] ?? 'Data tidak tersedia');
        $this->catalog = [
            1 => [
                'id' => 1,
