                ...
                @else
                    <ul
                        ...
                        <div class="flex gap-5 mt-4 text-white [&>li]:hover:text-sky-400 [&>li]:hover:text-shadow-slate-600  px-1 py-1.5 rounded-3xl [&>li]:hover:translate-x-1 [&>li]:hover:-translate-y-3 [&>li]:translate-y-1  [&>li]:transition-all [&>li]:duration-500">
                            <li class="relative"><a href="{{ route('devices') }}" class="text-3xl pl-7 flex items-center gap-4 group/climeet"> <i class="fa-solid fa-location-arrow"></i> <span class="text-xs absolute hidden delay-[5000] group-hover/climeet:block translate-x-1 translate-8 bg-white/80 text-slate-600 p-1 rounded-md">Lokasi</span></a></li>
